...
# For verilog
../build/src/bin/kepler_formal -verilog tinyrocket.v tinyrocket_edited.v NangateOpenCellLibrary_typical.lib fakeram45_1024x32.lib /example/fakeram45_64x32.lib 
```
