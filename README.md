...
The property of stable indices is employed to localize the scopes affected by edits and helps the Naja IF flow tp achieve superior performance relative to the Verilog flow when handling incremental modifications.
